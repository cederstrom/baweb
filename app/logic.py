...
from app import app
from app.models import TeamMember, Beer
...
def get_number_of_tickets_for_this_type_left_beer(ticket_type):
        max_number_of_tickets = app.config['ÖHLREISE']['ticket_types'][ticket_type]['max_nr']
        return max_number_of_tickets - Beer.ticket_count_by_type_beer(ticket_type)
